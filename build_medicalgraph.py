...
"""
新版本写法:
self.g = Graph("http://localhost:7474", auth=("neo4j", "mima"))
"""
class MedicalGraph:
    def __init__(self):
        ...
        self.g = Graph("http://localhost:7474", auth=("neo4j", "neo4j123456"))
    '''读取文件'''
    def read_nodes(self):
        # 共７类节点
        drugs = [] # 药品
        ...
        count = 0
        for data in open(self.data_path,encoding="utf-8"):#,encoding='UTF-8'
            disease_dict = {}
            count += 1
            print(count)
